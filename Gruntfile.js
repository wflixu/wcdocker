...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    jsdoc: {
      dist: {
        src: ["Code/*.js", "Code/*.jsdoc", "README.md"],
        options: {
          ...
          templates: {
            ...
            systemName:
              "<div style='font-size:15px;line-height:15px;margin-top:-5px;'>Web Cabin Docker<br>v3.0.0 (pre-release)</div>",
            footer: "",
            copyright: "",
            navType: "vertical",
            theme: "superhero",
    ...
    cssmin: {
      themes: {
        ...
        files: {
          "./Build/Themes/default.min.css": ["./Themes/default.css"],
          "./Build/Themes/bigRed.min.css": ["./Themes/bigRed.css"],
          "./Build/Themes/shadow.min.css": ["./Themes/shadow.css"],
          "./Build/Themes/ideDark.min.css": ["./Themes/ideDark.css"],
          "./Build/wcDocker.min.css": ["./Build/wcDocker.css"],
        },
      },
    },
  });
  ...
  grunt.registerTask("prepareBuild", ["copy:almond"]);
  ...
  grunt.registerTask("build", ["buildCode", "buildThemes"]);
};
